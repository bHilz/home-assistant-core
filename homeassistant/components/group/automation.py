"""Platform allowing several automation entities to be grouped into one automation entity."""
...
async def async_setup_platform(
    ...
    """Set up the Automation Group platform."""
    async_add_entities(
        [
            AutomationGroup(
...
class AutomationGroup(GroupEntity, ToggleEntity):
    """Representation of a automation group."""
